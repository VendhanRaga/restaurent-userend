...
const PaymentForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const { error: backeEndError, clientSecret } = await fetch('https://res-back.onrender.com/create-payment-intent', {
                method: 'POST',
                headers: {
    ...
    return (
        <form className="md:-2/3 md:mx-auto px-2 pt-1" id="payment-form" onSubmit={handleSubmit}>
            ...
            <div className="flex justify-center p-2">
                <Button type="submit" disbled={useNavigate('/payment-success')}>
                    {
                        loading ?
                        'Loading...' :
                        'Pay Now'
